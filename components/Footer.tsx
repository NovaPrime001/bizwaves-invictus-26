...
const Footer: React.FC = () => {
  return (
    <footer id="contact" className="bg-black/50 py-12 border-t border-cyan-500/20">
      <div className="container mx-auto px-6 text-center text-gray-400">
        <h2 className="font-montserrat text-2xl font-bold uppercase tracking-widest text-white mb-6">Contact Us</h2>
        <div className="flex justify-center space-x-8 mb-8">
            <a href="mailto:bizwaves@nitk.edu.in" className="hover:text-cyan-400 transition-colors">
        ...
        <div className="border-t border-gray-700/50 pt-6 mt-6">
            <p>&copy; {new Date().getFullYear()} BIZWAVES – INVICTUS'26. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
